...
"use strict";
Vue.component('posts', __webpack_require__(166));
...
/* scopeId */
var __vue_scopeId__ = "data-v-db97903a"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-db97903a", Component.options)
  } else {
    hotAPI.reload("data-v-db97903a", Component.options)
  }
...
var update = __webpack_require__(3)("2d46776e", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-db97903a\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Posts.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-db97903a\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Posts.vue");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sweetalert2__ = __webpack_require__(189);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getEditUrl: function getEditUrl(post) {
            return laroute.route('posts.edit', { post: post.id });
        },
        getDeleteUrl: function getDeleteUrl(post) {
        ...
        remove: function remove(post) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_sweetalert2___default()({
                ...
                if (result.value) {
                    window.axios.get(laroute.route('posts.destroy', { post: post.id })).then(function (response) {
                        if (response.status === 200) {
                            if (response.data.success) {
                                _this.postsList = _this.postsList.filter(function (p) {
                                    return p.id !== post.id;
                                });

                                __WEBPACK_IMPORTED_MODULE_0_sweetalert2___default()('Deleted!', response.data.message, 'success');
                            }
                        }
                    });
                }
...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.postsList, function(post) {
      return _c("div", { staticClass: "col-xs-12 col-md-12 my-2" }, [
          ...
          _c("div", { staticClass: "card-header clearfix" }, [
            _c(
              "a",
              {
                ...
                attrs: { href: _vm.getEditUrl(post) }
              },
              [_vm._v("Edit")]
            ),
            _vm._v(" "),
          ...
          _c("div", { staticClass: "card-body" }, [
            post.thumb
              ? _c("img", {
                  ...
                  attrs: { src: _vm.url + post.thumb, alt: post.name }
                })
              : _vm._e(),
            _vm._v(
              "\n                " + _vm._s(post.content) + "\n            "
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-db97903a", module.exports)
  }
}
